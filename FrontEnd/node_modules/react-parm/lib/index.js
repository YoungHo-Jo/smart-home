...
var createMethod = exports.createMethod = function createMethod(instance, method) {
  ...
  return (0, _utils.isClassComponent)(instance) ? (0, _utils.bindMethods)(instance) && function () {
...
var createRenderProps = exports.createRenderProps = function createRenderProps(instance, renderProps) {
  return (0, _utils.isClassComponent)(instance) ? (0, _utils.bindMethods)(instance) && function (props) {
...
var createValue = exports.createValue = function createValue(instance, getValue) {
  ...
  return (0, _utils.isClassComponent)(instance) ? (0, _utils.bindMethods)(instance) && getValue.call(instance, instance, extraArgs) : (0, _utils.logInvalidInstanceError)('value');
};
 ...
 */
var createComponent = exports.createComponent = function createComponent(render, passedOptions) {
