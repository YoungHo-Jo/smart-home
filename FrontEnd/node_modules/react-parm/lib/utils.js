...
exports.identity = exports.getNamespacedRef = exports.createRefCreator = exports.logInvalidInstanceError = exports.isClassComponent = exports.bindMethods = exports.addPropTypeIsRequired = exports.IGNORED_STATIC_KEYS = exports.IGNORED_COMPONENT_KEYS = exports.BOUND_METHODS = undefined;
...
var BOUND_METHODS = exports.BOUND_METHODS = ['forceUpdate', 'setState'];

/**
 * @constant {Object} IGNORED_COMPONENT_KEYS keys to ignore when creating a component
 */
var IGNORED_COMPONENT_KEYS = exports.IGNORED_COMPONENT_KEYS = {
 ...
 */
var IGNORED_STATIC_KEYS = exports.IGNORED_STATIC_KEYS = {
  displayName: true
};
 ...
 */
var addPropTypeIsRequired = exports.addPropTypeIsRequired = function addPropTypeIsRequired(propType) {
 ...
 * @returns {void}
 */
var bindMethods = exports.bindMethods = function bindMethods(instance) {
...
var getNamespacedRef = exports.getNamespacedRef = function getNamespacedRef(component) {
  return {
    component: component,
    element: (0, _reactDom.findDOMNode)(component)
  };
};
